...
class Document(Base):
    ...
    text_quality = Column(String(32), nullable=True, index=True)
    page_count = Column(Integer, nullable=True, index=True)
    sample_text_chars_first_3_pages = Column(Integer, nullable=True)
    inventory_source_path = Column(String(1024), nullable=True)
    ...
    processing_decision = Column(String(32), nullable=True)
    processing_decision_at = Column(DateTime(timezone=True), nullable=True)
    processing_decision_reason = Column(Text, nullable=True)
