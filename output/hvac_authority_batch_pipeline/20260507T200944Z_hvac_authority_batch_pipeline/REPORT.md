...
- Run ID: `20260507T200944Z_hvac_authority_batch_pipeline`
- Mode: `execute`
- Manifest: `workspace/hvac_source_inventory/20260507T083207Z/starter_batch_manifest.csv`
- Output dir: `output/hvac_authority_batch_pipeline/20260507T200944Z_hvac_authority_batch_pipeline`
...
| Name | Status | Seconds |
|---|---|---:|
| `oem_text_doclevel` | passed | 211.739 |
