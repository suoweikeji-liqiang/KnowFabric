...
- Run ID: `20260507T152047Z_hvac_authority_batch_pipeline`
- Mode: `dry-run`
- Manifest: `workspace/hvac_source_inventory/20260507T083207Z/starter_batch_manifest.csv`
- Output dir: `output/hvac_authority_batch_pipeline/20260507T152047Z_hvac_authority_batch_pipeline`
...
| Name | Status | Seconds |
|---|---|---:|
| `g36_0001_hvac系统高性能运行序列指南` | planned | - |
| `oem_text_doclevel` | planned | - |
