# KnowFabric Admin Web UI Design — 一次性粘贴版（Gemini）

> 此文件把 brief 和 prompt 合并成一份，给 AI Studio 不接受 .md 上传时使用。Cmd+A 全选 Cmd+C 复制全部，粘贴到 AI Studio 一次发送。

---

# Part A：设计上下文（brief，先读完）
